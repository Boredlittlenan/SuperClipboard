const translations = {
  ...
  en: {
    ...
    storageBackupBody: 'Backup controls now live inside Storage Settings beside Local and External mode configuration.',
