const translations = {
  'zh-CN': {
    ...
    releaseEyebrow: '当前版本',
    releaseTitle: '更顺手的编辑、标签与外部存储',
    releasePointOne: '多数据库连接快速切换',
    releasePointTwo: '编辑内容与首次原文分别复制',
    releasePointThree: '新版 UI 与多色 Tab 标签',
  ...
  en: {
    ...
    releaseTitle: 'Better editing, labels, and external storage',
    releasePointOne: 'Quick switching between database connections',
    releasePointTwo: 'Latest edits and first-captured originals copy separately',
    releasePointThree: 'Modern UI and multicolor Tab labels',
    ...
    downloadEyebrow: 'Current release · 3.1.0',
