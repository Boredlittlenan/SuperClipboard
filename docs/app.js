const translations = {
  'zh-CN': {
    ...
    releaseEyebrow: '当前版本',
    releaseTitle: '批量整理、分类与稳定性全面升级',
    releasePointOne: '多选、合并与批量删除让历史整理更高效',
    releasePointTwo: '历史分类可手动更新，旧数据不会被自动改写',
    releasePointThree: '远程存储、回收站与更新检查更稳定',
  ...
  en: {
    ...
    heroTitle: 'Keep what you copy organized and ready whenever you need it.',
    ...
    releaseTitle: 'Batch organization, smarter categories, and stronger reliability',
    releasePointOne: 'Select, merge, and delete history entries in batches',
    releasePointTwo: 'Refresh historical categories manually without automatic rewrites',
    releasePointThree: 'More reliable external storage, recycle bin, and update checks',
    ...
    downloadEyebrow: 'Current release · 3.5.0',
