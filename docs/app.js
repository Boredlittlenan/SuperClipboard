const translations = {
  'zh-CN': {
    ...
    releaseEyebrow: '当前版本',
    releaseTitle: '更稳定的语言、存储与远端加载',
    releasePointOne: '中英文与数据库切换状态保持一致',
    releasePointTwo: '外部图片进入可视区后按需加载',
    releasePointThree: '大列表分页与设置写入更稳定',
  ...
  en: {
    ...
    releaseTitle: 'More reliable language, storage, and remote loading',
    releasePointOne: 'Language and database switching stay in sync',
    releasePointTwo: 'External images load only near the viewport',
    releasePointThree: 'Stable pagination and ordered settings writes',
    ...
    downloadEyebrow: 'Current release · 3.3.0',
