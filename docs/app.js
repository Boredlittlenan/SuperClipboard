const translations = {
  'zh-CN': {
    ...
    supportEyebrow: '系统支持',
    supportTitle: '先把 Windows 做稳，macOS 已在计划里',
    supportWindowsStatus: '当前支持',
    supportWindowsBody: '当前正式支持 Windows x64，安装包包括 NSIS 安装器和 MSI 包。',
    supportMacStatus: '计划支持',
    supportMacBody: 'macOS 版本会在有 Mac 开发设备后开始适配、测试和打包。',
    privacyEyebrow: '隐私',
  ...
  en: {
    ...
    supportTitle: 'Stable on Windows first, macOS is on the roadmap',
    ...
    supportMacStatus: 'Planned',
    supportMacBody: 'The macOS version will start once dedicated Mac development hardware is available.',
