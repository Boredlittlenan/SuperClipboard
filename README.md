...
- `SuperClipboard_2.30.0_x64-setup.exe`: recommended Windows installer
- `SuperClipboard_2.30.0_x64_en-US.msi`: MSI package
...
- Since v2.30.0, local backup/restore uses the new `.scbackup` package format with manifest, data, and checksum metadata. Older gzip `.scbackup` and raw `.json` backups are no longer loaded.
