...
- `SuperClipboard_3.1.0_x64-setup.exe`：推荐使用的 Windows 安装器
- `SuperClipboard_3.1.0_x64_en-US.msi`：MSI 安装包
...
- 后端：Rust、Tauri v2、SQLite（`rusqlite`）、PostgreSQL（`r2d2` 连接池）、`arboard`
