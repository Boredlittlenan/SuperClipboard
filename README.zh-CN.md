...
- `SuperClipboard_2.20.0_x64-setup.exe`：推荐使用的 Windows 安装器
- `SuperClipboard_2.20.0_x64_en-US.msi`：MSI 安装包
...
- 存储设置(测试版)支持本地 / 外部 PostgreSQL 模式，并提供本地备份/恢复工具
...
- 自 v2.20.0 起，可通过存储设置(测试版)开启本地 / 外部存储模式配置和本地备份/恢复工具。
