...
- `SuperClipboard_2.3.0_x64-setup.exe`：推荐使用的 Windows 安装器
- `SuperClipboard_2.3.0_x64_en-US.msi`：MSI 安装包
...
- 自 v2.20.0 起，可通过存储设置(测试版)开启本地 / 外部存储模式配置。
- 自 v2.3.0 起，本地备份/恢复使用新版 `.scbackup` 包格式，内含清单、数据和校验信息。旧 gzip `.scbackup` 和裸 `.json` 备份不再读取。
